...
# ----------------------------------------
# If FPU_add_sub is one of several IP cores in your
...
# ----------------------------------------
# ACDS 19.1 240 win32 2024.01.04.11:58:52
...
if ![info exists TOP_LEVEL_NAME] { 
  set TOP_LEVEL_NAME "FPU_add_sub.FPU_add_sub"
}
...
if ![info exists QUARTUS_INSTALL_DIR] { 
  set QUARTUS_INSTALL_DIR "D:/asset/nam4hk2/de10_pro/tool_de10_pro/pathforinstall/quartus/"
}
...
set LD_LIBRARY_PATH [dict merge $LD_LIBRARY_PATH [dict get [FPU_add_sub::get_env_variables $SIMULATOR_TOOL_BITNESS] "LD_LIBRARY_PATH"]]
if {[dict size $LD_LIBRARY_PATH] !=0 } {
  set LD_LIBRARY_PATH [subst [join [dict keys $LD_LIBRARY_PATH] ":"]]
  setenv LD_LIBRARY_PATH "$LD_LIBRARY_PATH"
}
append ELAB_OPTIONS [subst [FPU_add_sub::get_elab_options $SIMULATOR_TOOL_BITNESS]]
append SIM_OPTIONS [subst [FPU_add_sub::get_sim_options $SIMULATOR_TOOL_BITNESS]]
...
alias file_copy {
  ...
  set memory_files [concat $memory_files [FPU_add_sub::get_memory_files "$QSYS_SIMDIR"]]
...
set design_libraries [dict merge $design_libraries [FPU_add_sub::get_design_libraries]]
...
alias com {
  ...
  set design_files [dict merge [FPU_add_sub::get_common_design_files $USER_DEFINED_COMPILE_OPTIONS $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_VHDL_COMPILE_OPTIONS "$QSYS_SIMDIR"]]
  set common_design_files [dict values $design_files]
  foreach file $common_design_files {
    eval $file
  }
  set design_files [list]
  set design_files [concat $design_files [FPU_add_sub::get_design_files $USER_DEFINED_COMPILE_OPTIONS $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_VHDL_COMPILE_OPTIONS "$QSYS_SIMDIR"]]
